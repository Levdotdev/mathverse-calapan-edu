 ...
 */
class _ApplicantController extends Controller {
    ...
    public function update()
    {
        if($this->io->method() == 'post'){
            ...
            $price = $this->io->post('unit_price');
                ...
                $this->StaffModel->update($key, $data);
    ...
    function trash(){
        ...
        $all = $this->StaffModel->page_trash($q, $records_per_page, $page);

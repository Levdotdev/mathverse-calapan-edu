...
<div id="modal" class="fixed inset-0 bg-black bg-opacity-40 hidden items-center justify-center z-50">
  ...
  <!-- Add Product Card -->
  <div class="w-full max-w-xl bg-white rounded-2xl shadow-xl overflow-hidden transform transition duration-300">
    <!-- Header -->
    <div class="p-5 sm:p-6 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
      ...
      <button id="closeModal" class="close-btn text-2xl font-bold focus:outline-none">&times;</button>
    </div>
      ...
      <form id="addProductForm">
        ...
        <div class="mb-4">
          ...
          <div class="input-wrapper relative">
            <i class="fas fa-tag input-icon absolute left-3 top-3 text-gray-400"></i>
            <input type="text" id="product_name" name="product_name"
              class="pl-10 w-full px-4 py-2.5 text-gray-800 border border-gray-300 rounded-lg focus:ring-1 focus:ring-primary-slate"
              placeholder="e.g., Ergonomic Wireless Mouse" required>
          </div>
        </div>
        ...
        <div class="mb-4">
          ...
          <div class="input-wrapper relative">
            <i class="fas fa-layer-group input-icon absolute left-3 top-3 text-gray-400"></i>
            <select id="category" name="category"
              class="pl-10 w-full px-4 py-2.5 text-gray-800 border border-gray-300 rounded-lg focus:ring-1 focus:ring-primary-slate appearance-none"
              required>
        ...
        <div class="mb-4">
          ...
          <div class="input-wrapper relative">
            <i class="fas fa-peso-sign input-icon absolute left-3 top-3 text-gray-400"></i>
        ...
        <div class="mb-4">
          ...
          <div class="input-wrapper relative">
            <i class="fas fa-barcode input-icon absolute left-3 top-3 text-gray-400"></i>
            <input type="text" id="product_id" name="product_id"
              class="pl-10 w-full px-4 py-2.5 text-gray-800 border border-gray-300 rounded-lg focus:ring-1 focus:ring-primary-slate"
              placeholder="Scan or enter unique product code">
          </div>
    ...
    <div class="p-5 sm:p-6 flex flex-col sm:flex-row justify-end gap-3 border-t border-gray-100 bg-gray-50">
      <button type="button" id="cancelModal"
        class="font-semibold text-primary-slate hover:bg-gray-200 px-4 py-2.5 rounded-lg transition duration-150 ease-in-out">
        <i class="fas fa-times-circle mr-2"></i> Cancel
      </button>

      <button type="submit" form="addProductForm" id="saveProductBtn"
        class="bg-primary-slate text-white font-semibold hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-300 px-4 py-2.5 rounded-lg transition duration-150 ease-in-out shadow-md hover:shadow-lg">
...
<script>
  ...
  // Open modal (trigger button from home page)
  const openModalBtn = document.getElementById('productModal'); // Ensure your open button has id="productModal"
